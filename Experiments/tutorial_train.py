...
# ONE-STEP UNET PATH
MODEL_CHOICE = "dmd2"
if MODEL_CHOICE == "dmd2":
    UNET_PATH = "runwayml/stable-diffusion-v1-5"
else:
    UNET_PATH = "/root/research/1-step-personalize/SB/ckpts/sbv2_fid81"
...
def main():
    ...
    ip_adapter.load_from_checkpoint(
    ...
    # vae.to(accelerator.device, dtype=torch.float32) # The VAE is in float32 to avoid NaN losses.
    ...
    for epoch in range(0, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(ip_adapter):
                ...
                timesteps = timesteps * (noise_scheduler.num_train_timesteps - 1)
