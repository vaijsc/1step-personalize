...
class SwiftBrushPipeline(StableDiffusionPipeline):
    """
    Pipeline for text-to-image generation using Swift Brush.
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            max_timesteps = torch.ones(
                latents.shape[0], dtype=torch.int64, device=latents.device
            )
