...
DMD2_REPO = "tianweiy/DMD2"
DMD2_CKPT = "model/sdv1.5/laion6.25_sd_baseline_8node_guidance1.75_lr5e-7_seed10_dfake10_diffusion1000_gan1e-3_resume_fid8.35_checkpoint_model_041000/pytorch_model.bin"
...
def main():
    ...
    unet.load_state_dict(
        torch.load(hf_hub_download(DMD2_REPO, DMD2_CKPT), map_location="cuda")
    )
    ###
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(text_encoder):
                ...
                # TESTING WITH NO NOISE PERTURBATION
                noisy_latents = noise
                ####################################
    ...
    if accelerator.is_main_process:
        plt.plot(losses)
        plt.savefig(f"{os.path.join(args.output_dir, args.logging_dir)}/losses.png")
