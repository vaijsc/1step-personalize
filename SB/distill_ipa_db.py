...
STUDENT_UNET_INIT = "ckpts/sbv2_sd1.5/0.7"
##########################
TEACHER_UNET_INIT = "/root/research/1-step-personalize/DreamBooth/dreambooth-output-sd-v1-5/checkpoint-200"
##########################
ip_adapter_path = "/root/.cache/huggingface/hub/models--h94--IP-Adapter/snapshots/018e402774aeeddd60609b4ecdb7e298259dc729/models/ip-adapter_sd15.bin"
ref_image_path = "/root/research/1-step-personalize/Data/dreambench/can/00.jpg"
ref_image_drop_rate = 0.05
ref_tokens = 64
...
def main(args):
    ...
    teacher_lora = UNet2DConditionModel.from_pretrained(
        TEACHER_UNET_INIT, subfolder="unet", revision=args.revision
    )
    ...
    unet = UNet2DConditionModel.from_pretrained(
        STUDENT_UNET_INIT, subfolder="unet", revision=args.revision
    )
    ...
    # Freeze vae, text encoders, student unet and image_encoder.
    ...
    image_proj_model = ImageProjModel(
        ...
        clip_extra_context_tokens=ref_tokens,
    )
    ...
    with torch.no_grad():
        clip_ref_image = clip_ref_image.to(accelerator.device, dtype=weight_dtype)
        ref_image_embeds = image_encoder(clip_ref_image).image_embeds
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(ip_adapter, teacher_lora):
                ...
                image_embeds = ref_image_embeds.repeat(bsz, 1, 1).to(
                    accelerator.device, dtype=weight_dtype
                )
